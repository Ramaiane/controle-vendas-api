...
public class ProdutoRestController {
	...
	@DeleteMapping("/{id}")
	@ApiOperation(value = "Ativa/Desativa um produto", notes = "Um ID válido deve ser informado", response = Produto.class)
	...
	public ResponseEntity<Resource> form(@PathVariable String imagem) {
		try {
		...
		//		responseEntity =  new ResponseEntity<Resource>(fileContent, httpHeaders, HttpStatus.OK);
